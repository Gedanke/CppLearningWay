...
Windows 平台需要相应软件 [Depends.exe](./tools/Depends.exe)
...
* 有一种 CPU 内部的寄存器是 32 位的，但总线是 16 位，准 32 位 CPU
...
如果想查看 C 程序的汇编代码，很多 IDE 都提供了反汇编这项功能
...
* Visual Studio Code，目前最流行，使用最多的 IDE，轻量高效，跨平台，几乎能在上面完成所有开发
