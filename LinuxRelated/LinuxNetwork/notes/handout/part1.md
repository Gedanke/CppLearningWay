...
ARP 帧：硬件类型0x0001表示以太网，协议类型0x0800表示IP协议，硬件地址(MAC地址)长度为6，协议地址(IP地址)长度为4，op为0x0001表示请求目的主机的MAC地址，源主机MAC地址为00:05:5d:61:58:a8，源主机IP地址为c0 a8 00 37(192.168.0.55)，目的主机MAC地址全0待填写，目的主机IP地址为c0 a8 00 02(192.168.0.2)。
